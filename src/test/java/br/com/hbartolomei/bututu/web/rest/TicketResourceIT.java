...
import br.com.hbartolomei.bututu.repository.TicketRepository;
...
class TicketResourceIT {
    ...
    public static Ticket createEntity(EntityManager em) {
        Ticket ticket = new Ticket().subject(DEFAULT_SUBJECT).creationDate(DEFAULT_CREATION_DATE);
        return ticket;
    }
    ...
    public static Ticket createUpdatedEntity(EntityManager em) {
        Ticket ticket = new Ticket().subject(UPDATED_SUBJECT).creationDate(UPDATED_CREATION_DATE);
        return ticket;
    }
    ...
    void putNewTicket() throws Exception {
        ...
        updatedTicket.subject(UPDATED_SUBJECT).creationDate(UPDATED_CREATION_DATE);
    ...
    void fullUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.subject(UPDATED_SUBJECT).creationDate(UPDATED_CREATION_DATE);
