...
import br.com.hbartolomei.bututu.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).creationDate(DEFAULT_CREATION_DATE);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE);
