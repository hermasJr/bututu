...
import br.com.hbartolomei.bututu.repository.JobRepository;
...
class JobResourceIT {
    ...
    public static Job createEntity(EntityManager em) {
        Job job = new Job().name(DEFAULT_NAME).creationDate(DEFAULT_CREATION_DATE).description(DEFAULT_DESCRIPTION);
        return job;
    }
    ...
    public static Job createUpdatedEntity(EntityManager em) {
        Job job = new Job().name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE).description(UPDATED_DESCRIPTION);
        return job;
    }
    ...
    void putNewJob() throws Exception {
        ...
        updatedJob.name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.creationDate(UPDATED_CREATION_DATE);
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE).description(UPDATED_DESCRIPTION);
