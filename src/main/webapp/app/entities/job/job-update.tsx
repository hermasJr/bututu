...
export const JobUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...jobEntity,
          creationDate: convertDateTimeFromServer(jobEntity.creationDate),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bututuApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="bututuApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('bututuApp.job.name')} id="job-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('bututuApp.job.creationDate')}
                id="job-creationDate"
                name="creationDate"
              ...
              />
              <ValidatedField
                label={translate('bututuApp.job.description')}
                id="job-description"
                name="description"
                data-cy="description"
                type="text"
