...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROPOSALITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROPOSALITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROPOSALITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROPOSALITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROPOSALITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROPOSALITEM actions', async () => {
      const expectedActions = [
        {
