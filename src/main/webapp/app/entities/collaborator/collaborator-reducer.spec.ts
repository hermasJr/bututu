...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLABORATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLABORATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLABORATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLABORATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLABORATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLABORATOR actions', async () => {
      const expectedActions = [
        {
