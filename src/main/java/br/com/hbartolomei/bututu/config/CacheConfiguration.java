package br.com.hbartolomei.bututu.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.hbartolomei.bututu.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.hbartolomei.bututu.repository.UserRepository.USERS_BY_EMAIL_CACHE);
