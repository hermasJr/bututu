...
import br.com.hbartolomei.bututu.repository.ClientRepository;
...
/**
 * REST controller for managing {@link br.com.hbartolomei.bututu.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getCommissionPct() != null) {
                    existingClient.setCommissionPct(client.getCommissionPct());
                }
